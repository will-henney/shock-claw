...
:END:
  #+begin_src python :tangle shock-test/cooling_function.py
    ...
    def cooling_source_term_step(solver, state, dt):
        ...
        return None
  #+end_src
*** Test the cooling function in a notebook
- This works great. I have lie plots of the profiles at a particular time, and also images of the space-time structure
- 
*** Estimating the isothermal Mach number of the fully-radiative shock
...
- Table
  |    U |      M |   M_ad | \rho_1/\rho_0 |  \rho_2/\rho_0 |  T_1/T_0 |
  |------+--------+-------+--------+---------+--------|
  | 0.01 |  1.005 | 0.778 |  1.000 |   1.010 |  1.000 |
  |  0.1 |  1.051 | 0.814 |  1.000 |   1.105 |  1.000 |
  |  0.2 |  1.105 | 0.856 |  1.000 |   1.221 |  1.000 |
  |  0.3 |  1.161 | 0.899 |  1.000 |   1.348 |  1.000 |
  |  0.4 |  1.220 | 0.945 |  1.000 |   1.488 |  1.000 |
  |  0.5 |  1.281 | 0.992 |  1.000 |   1.641 |  1.000 |
  |  0.6 |  1.344 | 1.041 |  1.061 |   1.806 |  1.041 |
  |  0.7 |  1.409 | 1.091 |  1.136 |   1.985 |  1.089 |
  |  0.8 |  1.477 | 1.144 |  1.215 |   2.182 |  1.141 |
  |  0.9 |  1.547 | 1.198 |  1.294 |   2.393 |  1.193 |
  |  1.0 |  1.618 | 1.253 |  1.374 |   2.618 |  1.246 |
  |  2.0 |  2.414 | 1.870 |  2.153 |   5.827 |  1.914 |
  |  5.0 |  5.193 | 4.022 |  3.374 |  26.967 |  5.919 |
  | 10.0 | 10.099 | 7.823 |  3.813 | 101.990 | 19.997 |
  #+TBLFM: $2=0.5 ($1 + sqrt($1**2 + 4));f3::$3=$2/sqrt(5/3);f3::$4=$3<1?1.0:4 $3**2 / ($3**2 + 3);f3::$5=$2**2;f3::$6=$3<1?1.0:(1/16) (5 $3**2 - 1) (1 + 3/$3**2);f3
